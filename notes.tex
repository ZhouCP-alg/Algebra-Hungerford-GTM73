...
\begin{proposition}
    If $A$ and $B$ are cycli modules over $R$ of nonzero orders $r$ and $s$ respectively. Let $d=(r,s)$ be the g.c.d of $r,s$and $m=[r,s]$ the l.c.m of $r,s$. Then the invariant factors of $A \oplus B$ are $d$ and $m$.
\end{proposition}
\begin{proof}
